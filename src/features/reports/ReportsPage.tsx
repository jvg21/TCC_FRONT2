  ...
  return (
    <PageContainer>
      ...
      <FilterSection>
        ...
        <ApplyFilterButton onClick={handleApplyFilter} disabled={loading}>
          <FiFilter /> {t('reports.filters.apply_filter')}
        </ApplyFilterButton>

        <ApplyFilterButton onClick={handleClearFilters} disabled={loading}>
