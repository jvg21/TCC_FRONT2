...
export const RagSearchButton = styled.button`
  display: flex;
  align-items: center;
  gap: 8px;
  padding: 10px 20px;
...
export const RagResultsHeader = styled.div`
  display: flex;
  justify-content: space-between;
  align-items: center;
  margin-bottom: 16px;
...
export const RagResultsClear = styled.button`
  display: flex;
  align-items: center;
  gap: 5px;
  background: none;
...
export const RagResultsList = styled.div`
  display: flex;
  flex-direction: column;
  gap: 12px;
`;
...
export const RagResultTitle = styled.div`
  display: flex;
  align-items: center;
  font-weight: 600;
  font-size: 16px;
